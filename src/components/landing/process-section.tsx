    ...
    <section id="how-it-works" className="scroll-mt-20 bg-paper text-ink">
      <div className="mx-auto max-w-[1240px] px-5 py-24 sm:px-8 sm:py-32">
        <div className="grid gap-10 lg:grid-cols-[.78fr_1.22fr] lg:gap-20">
          <div>
            <p className="font-mono text-xs uppercase tracking-[0.14em] text-evidence-soft">
              One durable route
            </p>
          ...
          <ol className="border-t border-ink/20">
            {productPrinciples.map((principle, index) => (
              ...
              >
                <span className="font-mono text-xs text-line-strong">
                  0{index + 1}
                </span>
                <p className="font-mono text-xs font-semibold uppercase tracking-[0.12em] text-evidence-soft">
                  {principle.label}
                </p>
                <div>
                  ...
                  <p className="mt-2 max-w-xl text-sm leading-6 text-surface-hover">
                    {principle.body}
                  </p>
                </div>
              </li>
